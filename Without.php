...
<head>
	...
	<script src="Js/FetchDet1.js"></script>
...
<body onPageShow="getLocation()">
  ...
  <header id="header">
	...
	<div class="container col-lg-6 col-md-4 col-sm-4 ">
		<form method="post" id="sign1" action="" enctype="multipart/form-data">
			...
			<fieldset class="col-lg-12 col-md-6 col-sm-6">
				...
				<input type="text" name="longitude" id="latitude" hidden="">
				<input type="text" name="latitude" id="longitude" hidden="">
				<div class="form-group" >
    				<input type="tell" id="contactno" name="contactno" style='width:60%; margin-left: 20%;'class="form-control" maxlength="12" required=""  placeholder="Please Enter the Contact Number" />
    				<br>
    				<input type="text" name="name" class="form-control" required="" placeholder="Please Enter Your Name" style='width:60%; margin-left: 20%;'>
    				<br>
    				<input type='submit' id='subm' class="btn btn-success" value="Submit" style='width:100pt; margin-left:40%; background-color: #18d26e;' />
  				</div>	
  				<br>
  				<span id="regmsg"></span>
  				<br>
